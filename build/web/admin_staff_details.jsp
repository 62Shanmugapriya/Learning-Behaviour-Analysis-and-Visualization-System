		...
		<div class="container">
		  <div class="title-div">
                ...
                <form name="form1" method="post" action="">
                  <table width="90%" height="80" align="center" id="table">
                    <thead>
                      <tr>
                        <th>id</th>
                        <th>NAME</th>
                    ...
                    <tbody>
                      <%
				ResultSet rs0=stmt3.executeQuery("select * from staff_details");
			...
			{				 
                      ...
                      <tr>
                        ...
                        <td><% out.print(rs0.getString("contact"));%></td>
                        <td><% out.print(rs0.getString("email"));%></td>
                        <td><% out.print(rs0.getString("address"));%></td>
                        <td><% out.print(rs0.getString("qualification"));%></td>
                       </tr>
                      <%
								}   
								   %>
