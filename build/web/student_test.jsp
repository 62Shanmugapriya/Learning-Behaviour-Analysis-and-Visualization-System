...
session.setAttribute("solitary1","0");
session.setAttribute("social2","0");
session.setAttribute("physical3","0");
session.setAttribute("arural4","0");
session.setAttribute("logical5","0");
session.setAttribute("verbal6","0");
session.setAttribute("visual7","0");
