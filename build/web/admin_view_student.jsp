	...
	<div class="contact">
		<div class="container">
		  <div class="title-div">
				<h3 class="tittle">
					<span>V</span>iew 
				<span>S</span>tudent				</h3>
                <form name="form1" method="post" action="">
                  <table width="98%" height="80" border="1" align="center" id="table">
                    <thead>
                      <tr>
                        <th>id</th>
                        <th>NAME</th>
                    ...
                    <tbody>
                      <%
				ResultSet rs0=stmt3.executeQuery("select * from student_reg");
		 
                   while(rs0.next())
			{				 
								 %>
                      <tr>
                        <td><% out.print(rs0.getString("rno"));%></td>
                        <td><% out.print(rs0.getString("name"));%></td>
                        <td><% out.print(rs0.getString("fathername"));%></td>
                        <td><% out.print(rs0.getString("age"));%></td>
                        <td><% out.print(rs0.getString("gender"));%></td>
                        <td><% out.print(rs0.getString("dob"));%></td>
                        <td><% out.print(rs0.getString("mnumber"));%></td>
                        <td><% out.print(rs0.getString("department"));%></td>
                        <td><% out.print(rs0.getString("address"));%></td>
                      </tr>
                      <%
								}   
								   %>
