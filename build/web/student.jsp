...
String pass=request.getParameter("apass");
 ...
 String qry="select * from student_reg where username='"+name+"' && password='"+pass+"' ";
 //out.print(qry);
				...
				<form name="form1" method="post" action="">
				  <table width="906" height="326" border="0" align="center">
                    <tr>
                      ...
                      <td width="272">&nbsp;</td>
                      <td width="205">&nbsp;</td>
                      <td colspan="4" rowspan="4"><img src="images/userlog.png" width="180" height="184"></td>
                    </tr>
                    <tr>
                      <td>&nbsp;</td>
                      <td>&nbsp;</td>
                      ...
                      <td><label>
                        <input name="aname" type="text" id="aname" required="">
                      </label></td>
                    </tr>
                    <tr>
                      <td>&nbsp;</td>
                      ...
                      <td><label>
                        <input name="apass" type="password" id="apass" required="">
                      </label></td>
                    </tr>
                    <tr>
                      <td>&nbsp;</td>
                    ...
                    <tr>
                      ...
                      <td>&nbsp;</td>
                      <td>&nbsp;</td>
                      <td><a href="student_register.jsp">New User </a></td>
                      <td colspan="4">&nbsp;</td>
                    </tr>
                    <tr>
                      <td>&nbsp;</td>
