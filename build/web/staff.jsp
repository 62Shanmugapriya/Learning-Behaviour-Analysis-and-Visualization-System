...
String pass=request.getParameter("apass");
 ...
 String qry="select * from staff_details where username='"+name+"' && password='"+pass+"' ";
ResultSet rs=stmt.executeQuery(qry);
if(rs.next())
{
		session.setAttribute("staff",name);
 String ss=rs.getString("id");
		session.setAttribute("sid",ss); 
				...
				<form name="form1" method="post" action="">
				  <table width="906" height="326" border="0" align="center">
                    <tr>
                      ...
                      <td width="272">&nbsp;</td>
                      <td width="205">&nbsp;</td>
                      <td colspan="4" rowspan="4"><img src="images/staff-login.png" width="180" height="137"></td>
                    </tr>
                    <tr>
                      <td>&nbsp;</td>
                      <td>&nbsp;</td>
