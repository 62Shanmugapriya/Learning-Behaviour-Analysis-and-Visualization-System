		  ...
		  <div class="title-div">
                ...
                <form name="form1" method="post" action="">
                  <table width="98%" height="80" border="1" align="center" id="table">
                    ...
                    <tbody>
                      <%
				ResultSet rs0=stmt3.executeQuery("select * from student_result");
			...
			{				 
                      ...
                      <tr>
                        ...
                        <td><% out.print(rs0.getString("uid"));%></td>
                        <td><% out.print(rs0.getString("solitary"));%></td>
                        <td><% out.print(rs0.getString("social"));%></td>
                        <td><% out.print(rs0.getString("physical"));%></td>
                        <td><% out.print(rs0.getString("arural"));%></td>
                        <td><% out.print(rs0.getString("logical"));%></td>
                        <td><% out.print(rs0.getString("verbal"));%></td>
                        <td><% out.print(rs0.getString("visual"));%></td>
                      </tr>
                      <%
								}   
								   %>
