...
if(a.equals("Submit"))
{
   ...
   int n = stmt1.executeUpdate(qry);
     ...
     String qry1 = "select max(id) as maxid from student_result";
            ...
            String ins = "insert into student_result values('"+id2+"','" + uid + "','"+solitary1+"','" + social2 + "','" + physical3 + "','"+arural4+"','"+logical5+"','"+verbal6+"','"+visual7+"','"+total+"')";                     
