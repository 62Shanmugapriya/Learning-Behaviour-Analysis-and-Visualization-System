		...
		<div class="container">
		  <div class="title-div">
                ...
                <form name="form1" method="post" action="">
                  ...
                  <table width="236" height="83" border="1" align="center">
                    <tr>
                      <td>Subject</td>
                      <td>View</td>
                    </tr>
					<%
					 ...
					 String qry2 = "select *  from notes_details where leanner_style='"+largestKeyValue+"'";
                                        // out.print(qry2);
            ...
            while (rs2.next()) 
            {
                    ...
                    <tr>
                      ...
                      <td><a href="student_recommendation_1.jsp?subject=<% out.print(rs2.getString("course_name"));%>&learner=<% out.print(rs2.getString("leanner_style"));%>">Select</a></td>
                    </tr>
					<%
					}
					%>
