...
String aa=request.getParameter("btn");
//out.print(aa);
if(aa.equals("Submit"))
{
...
java.util.Calendar calender=java.util.Calendar.getInstance();
        ...
        int id2=id1+1;   
   //out.print(id2);  
        String ins="insert into subject_questions values('"+id2+"','"+course_name+"','"+question+"','"+a1+"','"+a2+"','"+a3+"','"+correct_answer+"','0','0','"+cdate+"')";
		out.print(ins);
				...
				<div class="container">
					...
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						<nav class="link-effect-2" id="link-effect-2">
							...
							<%@ include file="include/staff_menu.jsp" %>	
				...
				<span>Q</span>uestion				</h3>
				 ...
				 <form name="form1" method="post" action="">
                  <table width="50%" height="200" border="0" align="center">
                    ...
                    <tr>
                      <td>Question</td>
                      <td><input name="question" type="text" id="question" required=""></td>
                    </tr>
                    <tr>
                      <td>Answer 1 </td>
                    ...
                    <tr>
                      <td>&nbsp;</td>
                      <td> 
                        <input name="btn" type="Submit" id="btn" value="Submit">                       </td>
                    </tr>
                  </table>
